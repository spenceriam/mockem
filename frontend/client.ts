 ...
 */
import { exportData as api_data_export_exportData } from "~backend/data/export";
import { generateData as api_data_generator_generateData } from "~backend/data/generator";
import {
    getSession as api_data_session_getSession,
    getSessionInfo as api_data_session_getSessionInfo
} from "~backend/data/session";
import { joinWaitlist as api_data_waitlist_joinWaitlist } from "~backend/data/waitlist";
...
export namespace data {
    ...
    export class ServiceClient {
        ...
        public async exportData(params: RequestType<typeof api_data_export_exportData>): Promise<ResponseType<typeof api_data_export_exportData>> {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_data_export_exportData>
        }
        ...
        public async generateData(params: RequestType<typeof api_data_generator_generateData>): Promise<ResponseType<typeof api_data_generator_generateData>> {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_data_generator_generateData>
        }

        /**
         * Get or create a session
         */
        public async getSession(): Promise<ResponseType<typeof api_data_session_getSession>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/session`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_data_session_getSession>
        }

        /**
         * Get current session info
         */
        public async getSessionInfo(params: RequestType<typeof api_data_session_getSessionInfo>): Promise<ResponseType<typeof api_data_session_getSessionInfo>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/session/info`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_data_session_getSessionInfo>
        }

        /**
         * Join the API access waitlist
         */
        public async joinWaitlist(params: RequestType<typeof api_data_waitlist_joinWaitlist>): Promise<ResponseType<typeof api_data_waitlist_joinWaitlist>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/waitlist`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_data_waitlist_joinWaitlist>
        }
    }
}
