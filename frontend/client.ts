...
import { getSession as api_data_session_getSession } from "~backend/data/session";
...
export namespace data {
    ...
    export class ServiceClient {
         ...
         */
        public async getSession(params: RequestType<typeof api_data_session_getSession>): Promise<ResponseType<typeof api_data_session_getSession>> {
            // Now make the actual call to the API
