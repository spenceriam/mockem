...
```bash
git remote add encore encore://mockem-data-generator-qxb2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/mockem-data-generator-qxb2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/mockem-data-generator-qxb2/settings/integrations/github)
